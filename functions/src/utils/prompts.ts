...
export const AGENT_2_SYSTEM = `You are an AI Pattern Detection Agent trained to identify the EXACT statistical signatures that AI content detection tools flag.
