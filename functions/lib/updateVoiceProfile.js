...
exports.updateVoiceProfileHandler = void 0;
...
const updateVoiceProfileHandler = async (req, res) => {
    ...
    try {
        const vpRef = admin.firestore().collection('voiceProfiles').doc(voiceProfileId);
...
exports.updateVoiceProfileHandler = updateVoiceProfileHandler;
//# sourceMappingURL=updateVoiceProfile.js.map